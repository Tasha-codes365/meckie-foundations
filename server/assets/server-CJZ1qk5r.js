...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-ChHC3wHr.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BoTqLLPi.js").then((n) => n.r),
...
var ROUTER_BASEPATH = "meckie-foundations";
var SERVER_FN_BASE = "/meckie-foundations/_serverFn/";
